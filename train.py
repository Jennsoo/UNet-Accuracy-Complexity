...
random.seed(1)  # Python random module.
torch.manual_seed(1)
...
class Trainer(object):
    def __init__(self, args):
        ...
        self.train_loader, self.val_loader, self.nclass, self.inchannel = make_data_loader(args, **kwargs)
    ...
    def validation(self, epoch):
        ...
        print('Validation:')
        print('[Epoch: %d, numImages: %5d]' % (epoch, i * self.args.batch_size + image.data.shape[0]))
        print("Acc:{}, Acc_class:{}, mIoU:{}, dice:{}, fwIoU:{}".format(Acc, Acc_class, mIoU, Dice, FWIoU))
...
def main():
    ...
    parser.add_argument('--baseline', type=str, default='unet2d',
                        choices=['unet2d', 'unet2doct'],
                        help='backbone name (default: unet2d)')
    parser.add_argument('--dataset', type=str, default='ctchest',
                        choices=['ctchest'],
                        help='dataset name (default: ctchest)')
    ...
    if args.checkname is None:
        args.checkname = str(args.baseline)
